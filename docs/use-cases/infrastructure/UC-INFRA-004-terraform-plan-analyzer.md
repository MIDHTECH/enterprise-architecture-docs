...
flowchart LR
    ...
    subgraph Planned["Planned Terraform Plan Analyzer control"]
...
1. The request binds Terraform Plan Analyzer to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Plan output summarizes creates, updates, destroys and replacement risk**
