...
flowchart LR
    ...
    subgraph Planned["Planned AWS VPC Landing Zone Setup control"]
...
1. The request binds AWS VPC Landing Zone Setup to immutable source, an inventory-resolved target,
