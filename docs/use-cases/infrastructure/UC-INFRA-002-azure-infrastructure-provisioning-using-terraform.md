...
flowchart LR
    ...
    subgraph Planned["Planned Azure Infrastructure Provisioning Using Terraform control"]
...
1. The request binds Azure Infrastructure Provisioning Using Terraform to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Azure stack covers resource group, VNet, VM, storage, database, container platform**
