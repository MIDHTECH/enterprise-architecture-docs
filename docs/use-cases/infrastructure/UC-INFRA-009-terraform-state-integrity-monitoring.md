...
The architecture conversation for Terraform State Integrity Monitoring should follow declared
...
![UC-INFRA-009 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-INFRA-009/UC-INFRA-009-architecture.svg)
