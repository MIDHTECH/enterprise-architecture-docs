...
flowchart LR
    ...
    subgraph Planned["Planned Cloud Resource Tagging Automation control"]
...
1. The request binds Cloud Resource Tagging Automation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Terraform variables and common tags standardize ownership/cost metadata**
