...
flowchart LR
    ...
    subgraph Planned["Planned Infrastructure Change Impact Analysis control"]
...
1. The request binds Infrastructure Change Impact Analysis to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Planned changes map to services, owners, SLOs, data feeds and runbooks**
