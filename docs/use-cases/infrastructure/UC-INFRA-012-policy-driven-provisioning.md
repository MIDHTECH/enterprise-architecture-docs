...
flowchart LR
    ...
    subgraph Planned["Planned Policy-Driven Provisioning control"]
...
1. The request binds Policy-Driven Provisioning to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Terraform changes are blocked when they violate standards**
