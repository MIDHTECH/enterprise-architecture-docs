...
flowchart LR
    ...
    subgraph Planned["Planned Server Configuration Automation Using Ansible control"]
...
1. The request binds Server Configuration Automation Using Ansible to immutable source, an inventory-resolved target,
