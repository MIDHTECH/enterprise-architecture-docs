...
flowchart LR
    ...
    subgraph Planned["Planned Linux Server Patch Automation control"]
...
1. The request binds Linux Server Patch Automation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Ansible common role handles package baseline and can run patching**
