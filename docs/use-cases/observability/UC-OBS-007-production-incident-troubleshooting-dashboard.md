...
A useful way for a new engineer to understand Production Incident Troubleshooting Dashboard is
to start with the operator decision the signal must support, then work backward to trustworthy
...
![UC-OBS-007 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-OBS-007/UC-OBS-007-architecture.svg)
