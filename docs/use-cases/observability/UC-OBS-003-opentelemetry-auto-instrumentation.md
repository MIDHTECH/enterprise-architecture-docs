...
| Supporting use cases | [UC-RSO-009](../resilience/UC-RSO-009-service-ownership.md), [UC-RSO-010](../resilience/UC-RSO-010-dependency-mapping.md), [UC-OBS-004](UC-OBS-004-centralized-log-management.md), [UC-OBS-001](UC-OBS-001-slo-as-code.md) |
...
In practice, OpenTelemetry Auto-Instrumentation makes sense when you start with the operator
...
The first buildable boundary is existing Prometheus, Alertmanager, Grafana, Loki, Tempo,
...
![UC-OBS-003 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-OBS-003/UC-OBS-003-architecture.svg)
