...
flowchart LR
    ...
    subgraph Planned["Planned Alerting and On-Call Notification control"]
...
1. The request binds Alerting and On-Call Notification to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Alerts route to incident channels or PagerDuty-style tools**
