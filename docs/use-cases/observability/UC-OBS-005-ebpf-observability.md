...
flowchart LR
    ...
    subgraph Planned["Planned eBPF Observability control"]
...
1. The request binds eBPF Observability to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Kernel-level telemetry captures runtime behavior where code changes are not practical**
