...
flowchart LR
    ...
    subgraph Planned["Planned Change-to-Incident Correlation control"]
...
1. The request binds Change-to-Incident Correlation to immutable source, an inventory-resolved target,
