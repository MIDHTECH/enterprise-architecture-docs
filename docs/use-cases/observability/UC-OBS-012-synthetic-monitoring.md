...
flowchart LR
    ...
    subgraph Planned["Planned Synthetic Monitoring control"]
...
1. The request binds Synthetic Monitoring to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **External checks validate user-facing availability**
