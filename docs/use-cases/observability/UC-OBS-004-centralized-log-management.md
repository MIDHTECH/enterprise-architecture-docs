...
flowchart LR
    ...
    subgraph Planned["Planned Centralized Log Management control"]
...
1. The request binds Centralized Log Management to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Logs from pods, VMs, and services collected centrally**
