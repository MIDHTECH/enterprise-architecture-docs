...
flowchart LR
    ...
    subgraph Planned["Planned Pipeline Template Standardization control"]
...
1. The request binds Pipeline Template Standardization to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Jenkins shared library and job DSL standardize pipelines**
