...
flowchart LR
    ...
    subgraph Planned["Planned Secrets Detection in Source Code control"]
...
1. The request binds Secrets Detection in Source Code to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Pipeline can run Gitleaks/TruffleHog-style checks**
