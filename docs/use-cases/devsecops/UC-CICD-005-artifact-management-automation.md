...
flowchart LR
    ...
    subgraph Planned["Planned Artifact Management Automation control"]
...
1. The request binds Artifact Management Automation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Build outputs and Docker images can be versioned and published**
