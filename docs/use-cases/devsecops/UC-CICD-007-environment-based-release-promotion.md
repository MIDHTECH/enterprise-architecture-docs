...
flowchart LR
    ...
    subgraph Planned["Planned Environment-Based Release Promotion control"]
...
1. The request binds Environment-Based Release Promotion to immutable source, an inventory-resolved target,
