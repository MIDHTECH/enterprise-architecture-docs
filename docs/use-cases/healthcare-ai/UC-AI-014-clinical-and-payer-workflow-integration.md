...
flowchart LR
    ...
    subgraph Planned["Planned Clinical and Payer Workflow Integration control"]
...
1. The request binds Clinical and Payer Workflow Integration to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **API-first integration into provider and insurance workflows**
