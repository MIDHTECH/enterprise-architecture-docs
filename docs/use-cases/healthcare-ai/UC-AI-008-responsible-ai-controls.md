...
flowchart LR
    ...
    subgraph Planned["Planned Responsible AI Controls control"]
...
1. The request binds Responsible AI Controls to immutable source, an inventory-resolved target,
...
| Responsible-AI review | Define affected groups, representative evaluation data, disparity measures, explanation expectations, reviewer authority, and the action taken when a threshold fails. |
...
- The canonical coverage test is: **Bias, transparency, approval and human-review guardrails**
