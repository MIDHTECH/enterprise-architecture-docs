...
| Primary implementation | `midhhealth/ai-and-ml-platform/healthcare-ai-platform/src/evaluations/payer_ai_assistant_platform.py`; entry point: the `evaluate_payer_ai_assistant_platform` offline evaluator |
