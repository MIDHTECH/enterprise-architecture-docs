...
The architecture conversation for AI Workflow Audit Logging should follow an approved question
...
including on rejected and replayed paths. In this page, **UC-OBS-004: Centralized Log
Management** contributes traceable measurement or alert decision with owner and diagnostic
context; **UC-GOV-001: Automated Compliance Evidence Collection** contributes
...
![UC-AI-009 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-AI-009/UC-AI-009-architecture.svg)
