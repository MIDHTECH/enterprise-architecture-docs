...
flowchart LR
    ...
    subgraph Planned["Planned AI Cost and Latency Optimization control"]
...
1. The request binds AI Cost and Latency Optimization to immutable source, an inventory-resolved target,
