...
flowchart LR
    ...
    subgraph Planned["Planned AI Observability control"]
...
1. The request binds AI Observability to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Metrics, traces, evaluations, failures and user feedback**
