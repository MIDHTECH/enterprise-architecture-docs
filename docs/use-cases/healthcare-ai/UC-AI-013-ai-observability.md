...
| Primary implementation | `midhhealth/ai-and-ml-platform/healthcare-ai-platform/src/evaluations/ai_observability.py`; entry point: the `evaluate_ai_observability` offline evaluator |
