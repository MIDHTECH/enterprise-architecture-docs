...
flowchart LR
    ...
    subgraph Planned["Planned AI Prompt and Response Evaluation control"]
...
1. The request binds AI Prompt and Response Evaluation to immutable source, an inventory-resolved target,
