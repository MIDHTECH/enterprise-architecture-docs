...
| Primary implementation | `midhhealth/ai-and-ml-platform/healthcare-ai-platform/src/evaluations/ai_prompt_and_response_evaluation.py`; entry point: the `evaluate_ai_prompt_and_response_evaluation` offline evaluator |
