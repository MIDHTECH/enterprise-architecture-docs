...
For design review, walk through AI Security and Access Control by trying to follow an approved
...
![UC-AI-011 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-AI-011/UC-AI-011-architecture.svg)
...
| Primary implementation | `midhhealth/ai-and-ml-platform/healthcare-ai-platform/src/evaluations/ai_security_and_access_control.py`; entry point: the `evaluate_ai_security_and_access_control` offline evaluator |
