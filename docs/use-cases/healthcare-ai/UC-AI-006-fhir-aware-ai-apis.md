...
| Primary implementation | `midhhealth/ai-and-ml-platform/healthcare-ai-platform/src/evaluations/fhir_aware_ai_apis.py`; entry point: the `evaluate_fhir_aware_ai_apis` offline evaluator |
