...
flowchart LR
    ...
    subgraph Planned["Planned FHIR-Aware AI APIs control"]
...
1. The request binds FHIR-Aware AI APIs to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Auditable clinical-data exchange for AI workflows**
