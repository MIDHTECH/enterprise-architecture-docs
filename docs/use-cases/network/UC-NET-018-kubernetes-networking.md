...
flowchart LR
    ...
    subgraph Planned["Planned Kubernetes Networking control"]
...
1. The request binds Kubernetes Networking to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Cluster dataplane and service networking**
