...
flowchart LR
    ...
    subgraph Planned["Planned MetalLB Address Management control"]
...
1. The request binds MetalLB Address Management to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Controlled service address pools**
