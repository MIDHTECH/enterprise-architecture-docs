...
flowchart LR
    ...
    subgraph Planned["Planned Capacity and Bandwidth Planning control"]
...
1. The request binds Capacity and Bandwidth Planning to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Forecasted network growth**
