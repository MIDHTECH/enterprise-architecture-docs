...
flowchart LR
    ...
    subgraph Planned["Planned DHCP Reservation Management control"]
...
1. The request binds DHCP Reservation Management to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Controlled address-to-MAC assignments**
