...
flowchart LR
    ...
    subgraph Planned["Planned Private Endpoint and Private DNS control"]
...
1. The request binds Private Endpoint and Private DNS to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Non-public managed-service access**
