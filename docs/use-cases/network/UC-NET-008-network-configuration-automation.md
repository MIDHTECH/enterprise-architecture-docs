...
flowchart LR
    ...
    subgraph Planned["Planned Network Configuration Automation control"]
...
1. The request binds Network Configuration Automation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Version-controlled Ansible changes**
