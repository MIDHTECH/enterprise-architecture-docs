...
flowchart LR
    ...
    subgraph Planned["Planned NAT and Egress Management control"]
...
1. The request binds NAT and Egress Management to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Controlled outbound and translation paths**
