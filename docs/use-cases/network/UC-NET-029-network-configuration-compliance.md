...
flowchart LR
    ...
    subgraph Planned["Planned Network Configuration Compliance control"]
...
1. The request binds Network Configuration Compliance to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Auditable device and service standards**
