...
flowchart LR
    ...
    subgraph Planned["Planned Certificate and TLS Routing control"]
...
1. The request binds Certificate and TLS Routing to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Trusted encrypted service entry**
