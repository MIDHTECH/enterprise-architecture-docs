...
flowchart LR
    ...
    subgraph Planned["Planned Network Availability Testing control"]
...
1. The request binds Network Availability Testing to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Synthetic and blackbox validation**
