...
flowchart LR
    ...
    subgraph Planned["Planned Network Performance Monitoring control"]
...
1. The request binds Network Performance Monitoring to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Latency, loss, throughput and saturation**
