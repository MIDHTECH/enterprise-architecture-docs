...
flowchart LR
    ...
    subgraph Planned["Planned Forward and Reverse DNS Automation control"]
...
1. The request binds Forward and Reverse DNS Automation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Synchronized A/PTR lifecycle**
