...
flowchart LR
    ...
    subgraph Planned["Planned Enterprise IP Address Management control"]
...
1. The request binds Enterprise IP Address Management to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Governed address and prefix allocation**
