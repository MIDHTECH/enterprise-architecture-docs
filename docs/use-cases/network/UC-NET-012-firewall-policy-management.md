...
flowchart LR
    ...
    subgraph Planned["Planned Firewall Policy Management control"]
...
1. The request binds Firewall Policy Management to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Reviewed least-privilege traffic policy**
