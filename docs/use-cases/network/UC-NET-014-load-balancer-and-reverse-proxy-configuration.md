...
flowchart LR
    ...
    subgraph Planned["Planned Load Balancer and Reverse Proxy Configuration control"]
...
1. The request binds Load Balancer and Reverse Proxy Configuration to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Standard application entry points**
