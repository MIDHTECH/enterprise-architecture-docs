...
flowchart LR
    ...
    subgraph Planned["Planned Authoritative and Recursive DNS control"]
...
1. The request binds Authoritative and Recursive DNS to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Managed internal name resolution**
