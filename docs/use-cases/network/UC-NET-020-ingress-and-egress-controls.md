...
flowchart LR
    ...
    subgraph Planned["Planned Ingress and Egress Controls control"]
...
1. The request binds Ingress and Egress Controls to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Governed workload traffic paths**
