...
flowchart LR
    ...
    subgraph Planned["Planned Layer 3 Routing control"]
...
1. The request binds Layer 3 Routing to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Static and dynamic route control**
