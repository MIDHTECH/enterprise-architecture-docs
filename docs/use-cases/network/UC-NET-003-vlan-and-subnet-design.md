...
flowchart LR
    ...
    subgraph Planned["Planned VLAN and Subnet Design control"]
...
1. The request binds VLAN and Subnet Design to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Standard segmentation and routing domains**
