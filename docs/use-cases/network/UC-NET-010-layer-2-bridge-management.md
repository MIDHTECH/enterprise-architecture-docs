...
flowchart LR
    ...
    subgraph Planned["Planned Layer 2 Bridge Management control"]
...
1. The request binds Layer 2 Bridge Management to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Host and virtualization switching**
