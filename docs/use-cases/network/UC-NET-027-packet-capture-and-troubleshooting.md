...
flowchart LR
    ...
    subgraph Planned["Planned Packet Capture and Troubleshooting control"]
...
1. The request binds Packet Capture and Troubleshooting to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Evidence-based protocol diagnosis**
