...
flowchart LR
    ...
    subgraph Planned["Planned Cloud VPC and VNet Networking control"]
...
1. The request binds Cloud VPC and VNet Networking to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Reusable cloud network foundations**
