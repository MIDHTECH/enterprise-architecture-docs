...
flowchart LR
    ...
    subgraph Planned["Planned CNI Policy and Troubleshooting control"]
...
1. The request binds CNI Policy and Troubleshooting to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Cilium/Hubble policy and visibility**
