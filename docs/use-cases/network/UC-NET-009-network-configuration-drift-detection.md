...
In practice, Network Configuration-Drift Detection makes sense when you trace the actual packet
...
![UC-NET-009 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-NET-009/UC-NET-009-architecture.svg)
