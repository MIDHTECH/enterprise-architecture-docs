...
flowchart LR
    ...
    subgraph Planned["Planned Hybrid-Cloud Connectivity control"]
...
1. The request binds Hybrid-Cloud Connectivity to immutable source, an inventory-resolved target,
