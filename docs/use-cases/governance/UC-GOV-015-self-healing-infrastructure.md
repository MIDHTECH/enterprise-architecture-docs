...
flowchart LR
    ...
    subgraph Planned["Planned Self-Healing Infrastructure control"]
...
1. The request binds Self-Healing Infrastructure to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Known safe failures are repaired and verified automatically**
