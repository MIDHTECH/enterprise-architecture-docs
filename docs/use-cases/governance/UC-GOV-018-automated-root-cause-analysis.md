...
flowchart LR
    ...
    subgraph Planned["Planned Automated Root-Cause Analysis control"]
...
1. The request binds Automated Root-Cause Analysis to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Telemetry, deployment and infrastructure changes are correlated for RCA**
