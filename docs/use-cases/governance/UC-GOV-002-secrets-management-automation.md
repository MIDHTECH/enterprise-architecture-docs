...
flowchart LR
    ...
    subgraph Planned["Planned Secrets Management Automation control"]
...
1. The request binds Secrets Management Automation to immutable source, an inventory-resolved target,
