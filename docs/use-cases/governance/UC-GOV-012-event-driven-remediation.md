...
flowchart LR
    ...
    subgraph Planned["Planned Event-Driven Remediation control"]
...
1. The request binds Event-Driven Remediation to immutable source, an inventory-resolved target,
