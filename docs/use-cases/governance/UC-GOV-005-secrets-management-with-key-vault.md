...
For design review, walk through Secrets Management with Key Vault by trying to separate what is
...
![UC-GOV-005 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-GOV-005/UC-GOV-005-architecture.svg)
