...
flowchart LR
    ...
    subgraph Planned["Planned Certificate Expiry Monitoring control"]
...
1. The request binds Certificate Expiry Monitoring to immutable source, an inventory-resolved target,
