...
flowchart LR
    ...
    subgraph Planned["Planned Intelligent Alert Deduplication control"]
...
1. The request binds Intelligent Alert Deduplication to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Repeated alerts are grouped into actionable incidents**
