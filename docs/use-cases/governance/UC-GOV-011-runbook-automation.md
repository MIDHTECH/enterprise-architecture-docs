...
flowchart LR
    ...
    subgraph Planned["Planned Runbook Automation control"]
...
1. The request binds Runbook Automation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Operational procedures become executable scripts or AWX workflows**
