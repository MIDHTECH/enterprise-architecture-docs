...
flowchart LR
    ...
    subgraph Planned["Planned Cloud IAM and RBAC Standardization control"]
...
1. The request binds Cloud IAM and RBAC Standardization to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Least-privilege roles and access patterns**
