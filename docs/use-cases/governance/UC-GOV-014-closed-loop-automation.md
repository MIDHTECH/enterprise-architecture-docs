...
flowchart LR
    ...
    subgraph Planned["Planned Closed-Loop Automation control"]
...
1. The request binds Closed-Loop Automation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Detect, remediate, validate and record recovery for low-risk failures**
