...
flowchart LR
    ...
    subgraph Planned["Planned Private Endpoint Implementation control"]
...
1. The request binds Private Endpoint Implementation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Restricts service access to private networks**
