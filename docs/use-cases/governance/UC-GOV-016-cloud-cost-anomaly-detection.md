...
flowchart LR
    ...
    subgraph Planned["Planned Cloud Cost Anomaly Detection control"]
...
1. The request binds Cloud Cost Anomaly Detection to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Spend or usage spikes are detected by owner and environment**
