...
flowchart LR
    ...
    subgraph Planned["Planned Resource Right-Sizing Automation control"]
...
1. The request binds Resource Right-Sizing Automation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Utilization recommends CPU, memory, storage and replica adjustments**
