...
Rather than beginning with a product, explain Configuration-Drift Detection by asking an
engineer to treat the host or fleet change as a canary-led operating procedure rather than a
