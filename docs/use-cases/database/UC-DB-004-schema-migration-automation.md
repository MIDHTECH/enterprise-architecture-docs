...
flowchart LR
    ...
    subgraph Planned["Planned Schema Migration Automation control"]
...
1. The request binds Schema Migration Automation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Ordered, tested and reversible changes**
