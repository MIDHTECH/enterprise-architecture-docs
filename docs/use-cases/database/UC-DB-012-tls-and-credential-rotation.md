...
flowchart LR
    ...
    subgraph Planned["Planned TLS and Credential Rotation control"]
...
1. The request binds TLS and Credential Rotation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Encrypted access and managed identities**
