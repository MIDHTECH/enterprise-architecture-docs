...
flowchart LR
    ...
    subgraph Planned["Planned Major-Version Upgrade Automation control"]
...
1. The request binds Major-Version Upgrade Automation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Rehearsed upgrade using supported methods**
