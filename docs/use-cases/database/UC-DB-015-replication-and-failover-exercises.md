...
flowchart LR
    ...
    subgraph Planned["Planned Replication and Failover Exercises control"]
...
1. The request binds Replication and Failover Exercises to immutable source, an inventory-resolved target,
...
| --- | --- |
| Failure transition and return | Name the trigger, blast radius, recovery point, success signal, failback criteria, and the authority that can end or reverse the exercise. |
...
- The canonical coverage test is: **Explicit cluster-only reliability testing**
