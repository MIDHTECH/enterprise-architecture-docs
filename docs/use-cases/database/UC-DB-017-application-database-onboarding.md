...
flowchart LR
    ...
    subgraph Planned["Planned Application Database Onboarding control"]
...
1. The request binds Application Database Onboarding to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Ownership, access, SLO and backup contract**
