...
flowchart LR
    ...
    subgraph Planned["Planned RPO and RTO Validation control"]
...
1. The request binds RPO and RTO Validation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Measured recovery objectives**
