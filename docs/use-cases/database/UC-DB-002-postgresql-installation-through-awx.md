...
flowchart LR
    ...
    subgraph Planned["Planned PostgreSQL Installation Through AWX control"]
...
1. The request binds PostgreSQL Installation Through AWX to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Versioned and repeatable installation**
