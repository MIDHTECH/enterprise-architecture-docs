...
flowchart LR
    ...
    subgraph Planned["Planned Backup and Point-in-Time Recovery control"]
...
1. The request binds Backup and Point-in-Time Recovery to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Defined recovery points and retention**
