...
flowchart LR
    ...
    subgraph Planned["Planned Database Auditing control"]
...
1. The request binds Database Auditing to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Privileged and sensitive activity evidence**
