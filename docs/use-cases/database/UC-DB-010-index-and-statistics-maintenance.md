...
flowchart LR
    ...
    subgraph Planned["Planned Index and Statistics Maintenance control"]
...
1. The request binds Index and Statistics Maintenance to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Controlled database optimization**
