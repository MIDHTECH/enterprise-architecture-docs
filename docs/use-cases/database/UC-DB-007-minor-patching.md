...
flowchart LR
    ...
    subgraph Planned["Planned Minor Patching control"]
...
1. The request binds Minor Patching to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Controlled maintenance with health validation**
