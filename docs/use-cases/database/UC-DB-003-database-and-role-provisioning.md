...
flowchart LR
    ...
    subgraph Planned["Planned Database and Role Provisioning control"]
...
1. The request binds Database and Role Provisioning to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Approved service onboarding**
