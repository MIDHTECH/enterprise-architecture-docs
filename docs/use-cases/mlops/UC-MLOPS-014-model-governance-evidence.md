...
flowchart LR
    ...
    subgraph Planned["Planned Model Governance Evidence control"]
...
1. The request binds Model Governance Evidence to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Audit records for regulated model operation**
