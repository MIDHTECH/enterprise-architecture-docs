...
| Primary implementation | `midhhealth/ai-and-ml-platform/mlops-model-platform/src/lifecycle/batch_inference.py`; entry point: the `run_batch_inference` lifecycle evaluator |
