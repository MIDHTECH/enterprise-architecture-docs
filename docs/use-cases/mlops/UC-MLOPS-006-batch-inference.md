...
flowchart LR
    ...
    subgraph Planned["Planned Batch Inference control"]
...
1. The request binds Batch Inference to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Scheduled scoring and downstream delivery**
