...
| Primary implementation | `midhhealth/ai-and-ml-platform/mlops-model-platform/src/lifecycle/model-rollback.py`; entry point: the `run_model_rollback` lifecycle evaluator |
