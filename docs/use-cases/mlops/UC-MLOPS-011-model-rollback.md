...
flowchart LR
    ...
    subgraph Planned["Planned Model Rollback control"]
...
1. The request binds Model Rollback to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Safe recovery to a prior approved model**
