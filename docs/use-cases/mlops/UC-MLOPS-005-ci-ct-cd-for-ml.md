...
The architecture conversation for CI/CT/CD for ML should keep dataset, code, parameters, model
...
Model Validation Gates** contributes model quality/safety gate and reviewer decision. The first
...
![UC-MLOPS-005 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-MLOPS-005/UC-MLOPS-005-architecture.svg)
...
| Primary implementation | `midhhealth/ai-and-ml-platform/mlops-model-platform/src/lifecycle/ci_ct_cd_for_ml.py`; entry point: the `run_ci_ct_cd_for_ml` lifecycle evaluator |
