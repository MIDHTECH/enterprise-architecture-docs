...
flowchart LR
    ...
    subgraph Planned["Planned Experiment Tracking control"]
...
1. The request binds Experiment Tracking to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Metrics, artifacts, parameters and reproducibility**
