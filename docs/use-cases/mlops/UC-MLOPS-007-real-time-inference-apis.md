...
flowchart LR
    ...
    subgraph Planned["Planned Real-Time Inference APIs control"]
...
1. The request binds Real-Time Inference APIs to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Low-latency model serving**
