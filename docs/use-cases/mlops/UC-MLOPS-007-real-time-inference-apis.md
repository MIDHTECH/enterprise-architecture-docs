...
| Primary implementation | `midhhealth/ai-and-ml-platform/mlops-model-platform/src/lifecycle/real_time_inference_apis.py`; entry point: the `run_real_time_inference_apis` lifecycle evaluator |
