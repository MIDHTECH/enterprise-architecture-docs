...
The architecture conversation for Streaming Data Ingestion should follow a named producer record
...
![UC-DATA-003 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-DATA-003/UC-DATA-003-architecture.svg)
