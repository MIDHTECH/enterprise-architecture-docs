...
flowchart LR
    ...
    subgraph Planned["Planned Data Retention and Archival control"]
...
1. The request binds Data Retention and Archival to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Policy-driven dataset lifecycle**
