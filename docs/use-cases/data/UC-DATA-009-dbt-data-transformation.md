...
flowchart LR
    ...
    subgraph Planned["Planned dbt Data Transformation control"]
...
1. The request binds dbt Data Transformation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Tested SQL transformation and documentation**
