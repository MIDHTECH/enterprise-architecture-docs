...
flowchart LR
    ...
    subgraph Planned["Planned Change-Data Capture control"]
...
1. The request binds Change-Data Capture to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Database changes published without application coupling**
