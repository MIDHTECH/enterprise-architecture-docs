...
flowchart LR
    ...
    subgraph Planned["Planned Data Lineage control"]
...
1. The request binds Data Lineage to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Source-to-consumer traceability**
