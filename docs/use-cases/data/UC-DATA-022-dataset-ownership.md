...
flowchart LR
    ...
    subgraph Planned["Planned Dataset Ownership control"]
...
1. The request binds Dataset Ownership to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Data-product accountability and support**
