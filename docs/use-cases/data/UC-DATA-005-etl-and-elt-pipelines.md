...
For design review, walk through ETL and ELT Pipelines by trying to follow a named producer
...
| Primary implementation | `midhhealth/data-and-integration/data-engineering-platform/src/use_cases/etl_and_elt_pipelines.py`; entry point: the `run_etl_and_elt_pipelines` evaluation entry point |
