...
flowchart LR
    ...
    subgraph Planned["Planned Event-Contract Management control"]
...
1. The request binds Event-Contract Management to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Ownership and versioning of event interfaces**
