...
| Primary implementation | `midhhealth/data-and-integration/data-engineering-platform/src/use_cases/event-contract-management.py`; entry point: the `run_event_contract_management` evaluation entry point |
