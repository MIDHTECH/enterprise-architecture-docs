...
flowchart LR
    ...
    subgraph Planned["Planned Pipeline Retry and Backfill control"]
...
1. The request binds Pipeline Retry and Backfill to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Safe historical reprocessing**
