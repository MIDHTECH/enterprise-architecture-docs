...
flowchart LR
    ...
    subgraph Planned["Planned Metadata Catalog and Discovery control"]
...
1. The request binds Metadata Catalog and Discovery to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Searchable datasets and ownership**
