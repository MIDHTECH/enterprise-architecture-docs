...
| Primary implementation | `midhhealth/data-and-integration/data-engineering-platform/src/use_cases/batch_data_ingestion.py`; entry point: the `run_batch_data_ingestion` evaluation entry point |
