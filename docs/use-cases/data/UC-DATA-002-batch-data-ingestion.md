...
flowchart LR
    ...
    subgraph Planned["Planned Batch Data Ingestion control"]
...
1. The request binds Batch Data Ingestion to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Scheduled and recoverable source ingestion**
