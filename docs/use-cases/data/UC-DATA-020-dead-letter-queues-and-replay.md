...
flowchart LR
    ...
    subgraph Planned["Planned Dead-Letter Queues and Replay control"]
...
1. The request binds Dead-Letter Queues and Replay to immutable source, an inventory-resolved target,
