...
flowchart LR
    ...
    subgraph Planned["Planned Workflow Orchestration control"]
...
1. The request binds Workflow Orchestration to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Dependency, retry and scheduling control**
