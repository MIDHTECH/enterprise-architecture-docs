...
flowchart LR
    ...
    subgraph Planned["Planned PII Controls control"]
...
1. The request binds PII Controls to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Restricted handling of personal data**
