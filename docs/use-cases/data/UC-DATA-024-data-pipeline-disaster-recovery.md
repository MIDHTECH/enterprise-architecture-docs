...
![UC-DATA-024 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-DATA-024/UC-DATA-024-architecture.svg)
