...
| Supporting use cases | [UC-DATA-015](UC-DATA-015-data-classification.md), [UC-GOV-004](../governance/UC-GOV-004-cloud-iam-and-rbac-standardization.md), [UC-DATA-008](UC-DATA-008-event-contract-management.md), [UC-DATA-023](UC-DATA-023-data-access-governance.md) |
...
GitLab shared runner, synthetic fixtures, PostgreSQL where approved, and current evidence paths.
The design stops at this rule: Reuse the existing lab; do not create a new data platform, Kafka,
...
| --- | --- | --- | --- |
| Required upstream contract | [UC-DATA-015: Data Classification](UC-DATA-015-data-classification.md) | validated data result with counts, lineage, quality, and reconciliation state | Missing, stale, or contradictory handoff stops the dependent decision and is recorded for the accountable owner. |
...
| Coordinated assurance handoff | [UC-DATA-008: Event-Contract Management](UC-DATA-008-event-contract-management.md) | validated data result with counts, lineage, quality, and reconciliation state | Missing, stale, or contradictory handoff stops the dependent decision and is recorded for the accountable owner. |
| Coordinated assurance handoff | [UC-DATA-023: Data Access Governance](UC-DATA-023-data-access-governance.md) | validated data result with counts, lineage, quality, and reconciliation state | Missing, stale, or contradictory handoff stops the dependent decision and is recorded for the accountable owner. |
