...
A useful way for a new engineer to understand Data Lake and Lakehouse Storage is to follow a
...
![UC-DATA-011 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-DATA-011/UC-DATA-011-architecture.svg)
...
| Primary implementation | `midhhealth/data-and-integration/data-engineering-platform/src/use_cases/data_lake_and_lakehouse_storage.py`; entry point: the `run_data_lake_and_lakehouse_storage` evaluation entry point |
