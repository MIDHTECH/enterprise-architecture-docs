...
flowchart LR
    ...
    subgraph Planned["Planned Data Reconciliation control"]
...
1. The request binds Data Reconciliation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Source and target correctness validation**
