...
flowchart LR
    ...
    subgraph Planned["Planned Kubernetes Cost Allocation control"]
...
1. The request binds Kubernetes Cost Allocation to immutable source, an inventory-resolved target,
