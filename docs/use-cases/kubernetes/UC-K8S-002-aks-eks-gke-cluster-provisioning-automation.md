...
The architecture conversation for AKS/EKS/GKE Cluster Provisioning Automation should trace one
...
identity or evidence from an earlier one. In this page, **UC-INFRA-001: Terraform Drift
Detection** contributes desired/observed infrastructure identity and drift result; **UC-NET-018:
...
![UC-K8S-002 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-K8S-002/UC-K8S-002-architecture.svg)
