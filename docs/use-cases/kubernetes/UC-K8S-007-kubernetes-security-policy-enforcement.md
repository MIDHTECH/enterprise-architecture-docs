...
flowchart LR
    ...
    subgraph Planned["Planned Kubernetes Security Policy Enforcement control"]
...
1. The request binds Kubernetes Security Policy Enforcement to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **OPA Gatekeeper/Kyverno blocks unsafe workloads**
