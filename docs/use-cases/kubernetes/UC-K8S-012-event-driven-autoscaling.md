...
flowchart LR
    ...
    subgraph Planned["Planned Event-Driven Autoscaling control"]
...
1. The request binds Event-Driven Autoscaling to immutable source, an inventory-resolved target,
...
| Ordering and replay | Define delivery semantics, offsets or checkpoints, duplicate handling, late data, poison records, bounded replay, and downstream reconciliation. |
...
- The canonical coverage test is: **Workloads scale from queues, events or custom metrics**
