...
flowchart LR
    ...
    subgraph Planned["Planned Automated Incident Evidence Collection control"]
...
1. The request binds Automated Incident Evidence Collection to immutable source, an inventory-resolved target,
...
| Telemetry integrity | Preserve timestamps, labels, correlation identifiers, source coverage, retention boundaries, and visibility of gaps or sampling. |
...
- The canonical coverage test is: **Logs, metrics, traces and changes captured**
