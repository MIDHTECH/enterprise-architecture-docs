...
flowchart LR
    ...
    subgraph Planned["Planned Dependency Mapping control"]
...
1. The request binds Dependency Mapping to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Runtime and service relationship visibility**
