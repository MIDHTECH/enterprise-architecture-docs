...
flowchart LR
    ...
    subgraph Planned["Planned Problem Management control"]
...
1. The request binds Problem Management to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Recurring failure elimination**
