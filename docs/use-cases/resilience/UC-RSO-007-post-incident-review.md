...
flowchart LR
    ...
    subgraph Planned["Planned Post-Incident Review control"]
...
1. The request binds Post-Incident Review to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Blameless corrective-action tracking**
