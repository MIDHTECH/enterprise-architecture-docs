...
flowchart LR
    ...
    subgraph Planned["Planned Capacity and Saturation Testing control"]
...
1. The request binds Capacity and Saturation Testing to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Resource-limit discovery**
