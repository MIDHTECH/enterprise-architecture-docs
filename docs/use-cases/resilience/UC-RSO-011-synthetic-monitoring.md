...
Enterprise Resilience and Service Operations Platform: **User-path availability testing**. Without a shared design, teams can perform
...
- The canonical coverage test is: **User-path availability testing**
...
| Planned `UC-RSO-011/contract` | Define inputs, owner, target allowlist, mode, coverage, policy, outputs, and safe stop |
| Planned `UC-RSO-011/result-schema` | Normalize provenance, observed values, decision, safety, recovery, and review fields |
| Planned `UC-RSO-011/fixtures` | Exercise passing, blocking, malformed, unauthorized, unavailable-dependency, and recovery cases |
