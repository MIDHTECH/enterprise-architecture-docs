...
flowchart LR
    ...
    subgraph Planned["Planned Incident Detection and Classification control"]
...
1. The request binds Incident Detection and Classification to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Consistent severity and ownership**
