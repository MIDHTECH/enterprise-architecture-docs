...
| Supporting use cases | [UC-OBS-001](../observability/UC-OBS-001-slo-as-code.md), [UC-RSO-009](UC-RSO-009-service-ownership.md), [UC-RSO-005](UC-RSO-005-on-call-and-escalation-workflows.md), [UC-OBS-014](../observability/UC-OBS-014-change-to-incident-correlation.md) |
...
verify recovery and preserve what the team learned. In this page, **UC-OBS-001: SLO as Code**
...
| Coordinated assurance handoff | [UC-RSO-005: On-Call and Escalation Workflows](UC-RSO-005-on-call-and-escalation-workflows.md) | readiness or exercise result tied to observed service recovery | Missing, stale, or contradictory handoff stops the dependent decision and is recorded for the accountable owner. |
