...
flowchart LR
    ...
    subgraph Planned["Planned AWX Automated Remediation control"]
...
1. The request binds AWX Automated Remediation to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Guarded, auditable operational fixes**
