...
flowchart LR
    ...
    subgraph Planned["Planned Maintenance-Window Management control"]
...
1. The request binds Maintenance-Window Management to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Planned service-impact coordination**
