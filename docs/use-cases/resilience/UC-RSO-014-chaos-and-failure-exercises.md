...
flowchart LR
    ...
    subgraph Planned["Planned Chaos and Failure Exercises control"]
...
1. The request binds Chaos and Failure Exercises to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Controlled dependency and component failures**
