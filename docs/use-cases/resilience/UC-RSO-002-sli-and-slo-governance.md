...
![UC-RSO-002 architecture showing demand, source contracts, planned control, existing target, evidence, and recovery](../../assets/use-cases/UC-RSO-002/UC-RSO-002-architecture.svg)
