...
flowchart LR
    ...
    subgraph Planned["Planned RTO and RPO Measurement control"]
...
1. The request binds RTO and RPO Measurement to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Evidence-based recovery objectives**
