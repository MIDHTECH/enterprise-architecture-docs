...
flowchart LR
    ...
    subgraph Planned["Planned Error-Budget Management control"]
...
1. The request binds Error-Budget Management to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Release and reliability decisions based on risk**
