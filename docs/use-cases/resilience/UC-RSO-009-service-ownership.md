...
flowchart LR
    ...
    subgraph Planned["Planned Service Ownership control"]
...
1. The request binds Service Ownership to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Named technical and business accountability**
