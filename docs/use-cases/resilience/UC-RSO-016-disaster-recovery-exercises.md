...
flowchart LR
    ...
    subgraph Planned["Planned Disaster-Recovery Exercises control"]
...
1. The request binds Disaster-Recovery Exercises to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Full workflow rehearsal**
