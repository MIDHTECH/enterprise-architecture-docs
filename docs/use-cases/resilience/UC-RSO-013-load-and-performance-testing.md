...
flowchart LR
    ...
    subgraph Planned["Planned Load and Performance Testing control"]
...
1. The request binds Load and Performance Testing to immutable source, an inventory-resolved target,
...
- The canonical coverage test is: **Repeatable workload validation**
