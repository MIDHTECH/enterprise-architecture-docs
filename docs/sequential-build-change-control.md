...
| Blocker | Corrected source is under review. Initial pipelines 522-524 remained pending because Kubernetes/library jobs had no tags and the cloud branch was ten commits behind current tagged main after the legacy untagged runner was retired. Revisions `8b169e0` and `37027a3` add `validation`; cloud revision `e98e793` incorporates current main and its canonical `infra` routing. Replacement CI is running. INC-2026-078 and INC-2026-079 remain open. |
