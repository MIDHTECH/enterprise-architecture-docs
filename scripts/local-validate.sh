...
required_docs=(
  ...
  "docs/use-cases/observability/UC-OBS-001-slo-burn-rate-alerting.md"
  ...
  "docs/use-cases/healthcare-ai/UC-AI-001-governed-enterprise-knowledge-rag.md"
  "docs/use-cases/mlops/UC-MLOPS-001-model-registration-validation.md"
)
